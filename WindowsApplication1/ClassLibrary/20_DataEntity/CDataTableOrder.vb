Public Class CDataTableOrder
    ...
    '根据代码、日期，返回Order的集合
    Public Function GetOrdersByCode_Date(sSymbol As String, sDate As String) As Collection
    ...
    Public Sub GetSystemTestResult(oSTR As CStrategy_TestResult, fCurrentPrice As Single)

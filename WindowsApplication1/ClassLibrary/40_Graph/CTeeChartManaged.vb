...
Public Class CTeeChartManaged
    ...
    Public Sub InitCandleGraph(chart As Styles.Candle)
        'chart.ClearChart()
        chart.Legend.Visible = False
        'chart.HorizAxis.Bottom.
    ...
    ''' <remarks></remarks>
    Public Sub InitCandleGraph(chart As TChart)
        'chart.ClearChart()
        chart.Legend.Visible = False
        'chart.HorizAxis.Bottom.
        ' chart.Aspect.View3D = False
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Protected Sub ClearIndicators(ByRef chart As TChart)
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Protected Sub ClearIndicator(ByRef chart As TChart, ByVal IndicatorName As String)
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Protected Sub PlotIndicators(ByRef chart As TChart)
    ...
    Public Sub AddCandlePrice(ByRef chart As Styles.Candle, ByVal dt As CDTDaily, Optional ByVal pat As EPriceAdjustedType = EPriceAdjustedType.Normal)
        Try
            ...
            If Not IsNothing(dt) Then
                With chart
                    ...
                    For Each row As DataRow In dt.Rows
                        ...
                        If pat = EPriceAdjustedType.Normal Then
                        ...
                        ElseIf pat = EPriceAdjustedType.ForAdj Then
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Sub AddCandlePricefromDataTable(ByRef chart As TChart, ByVal dt As CDTDaily, Optional ByVal pat As EPriceAdjustedType = EPriceAdjustedType.Normal)
        Try
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Sub AddCandleVolumefromDataTable(ByRef chart As TChart, ByVal dt As CDTDaily, Optional ByVal pat As EPriceAdjustedType = EPriceAdjustedType.Normal)
        Try
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Sub AddIndicator(ByRef chart As TChart, ByVal idc As CIndicator)
        Try
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Sub RemoveIndicator(ByRef chart As TChart, ByVal idc As CIndicator)
        Try
